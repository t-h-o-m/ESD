...
client = ovh.Client(
    ...
    application_key='sQkRcQjGAFapnsra',    # Application Key
    application_secret='8YDwRvrAphukesXlIz9i6ExqEEWbHrds', # Application Secret
    consumer_key='rRkqeTeKTdHtxpGuD2e4I763KaMAAPkJ',       # Consumer Key
)
...
result = client.post('/cloud/project/8b98da39645b4f119ae33b1087d2355f/instance', 
    ...
    monthlyBilling=billtype, #// Active monthly billing (type: boolean)
